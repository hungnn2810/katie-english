...
import { ClassStatus } from '@/lib/admin-api';
          ...
          return (
            <Button
              ...
              sx={{
                ...
                ...(active
                  ? { bgcolor: colors.adminAccentBg, color: ACCENT, borderColor: ACCENT, '&:hover': { bgcolor: colors.adminAccentBg } }
      ...
      {withSchedule.length > 0 ? (
        ...
        <Box sx={{
          ...
          <Typography sx={{ fontSize: 14, color: '#6B7280', mt: 0.5 }}>
            Thêm lịch học trong phần quản lý lớp
          </Typography>
        </Box>
      )}
    </Box>
