...
export default function StudentLoginPage() {
  ...
  return (
    <Box sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', px: { xs: '20px', sm: 3 }, py: { xs: '32px', sm: '32px' } }}>
      <Box sx={{ width: '100%', maxWidth: { xs: 440, sm: 440 }, display: 'flex', flexDirection: 'column', bgcolor: '#FFFFFF', borderRadius: '24px', p: { xs: '28px', sm: '40px' }, boxShadow: '0 8px 40px rgba(109,40,217,0.12), 0 2px 8px rgba(0,0,0,0.06)', border: '1.5px solid rgba(167,139,250,0.2)' }}>
