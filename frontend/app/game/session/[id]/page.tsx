...
export default function SessionPage() {
  ...
  const processWord = useCallback(async (index: number, detected: string) => {
    ...
    let score = 0;
    try { const r = await saveWordResult(sessionId, word.wordId, detected); score = r.score; } catch {}
          ...
          <div className="min-h-screen py-12 px-8" style={{ background: gradients.gameBg, minWidth: 1024 }}>
            <div className="max-w-xl mx-auto">
              ...
              <div className="space-y-3 mb-8">
                {words.map((w) => (
                  <div key={w.wordId} className="bg-white bg-opacity-10 rounded-2xl px-5 py-4 flex items-center justify-between">
                    <div>
